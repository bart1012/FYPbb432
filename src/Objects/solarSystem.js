...
class SolarSystem{
    ...
    create(){
        ...
        const interpolatedPoint5 = new Vector3().lerpVectors(lineVertices[0], lineVertices[1], 0.58);
        ...
        //saturn rings
        const torus = new TorusGeometry(2.1,0.75,2,80);
        torus.computeVertexNormals();
        var ringsTexture = getSaturnRings();
        // var ringsTexture = new MeshBasicMaterial();
